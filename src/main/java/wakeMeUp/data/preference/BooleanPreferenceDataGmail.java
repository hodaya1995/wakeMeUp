...
import me.jfenn.wakeMeUp.fragments.SettingsFragment;

public class BooleanPreferenceDataGmail extends BasePreferenceData<BooleanPreferenceDataGmail.ViewHolder> {
    ...
    public BooleanPreferenceDataGmail(PreferenceData preference, @StringRes int title, @StringRes int description,boolean check) {
    ...
    public BasePreferenceData.ViewHolder getViewHolder(LayoutInflater inflater, ViewGroup parent) {
        return new BooleanPreferenceDataGmail.ViewHolder(inflater.inflate(R.layout.item_preference_boolean, parent, false));
    }

    @Override
    public void bindViewHolder(final BooleanPreferenceDataGmail.ViewHolder holder) {
        ...
        holder.toggle.setChecked(value != null ? value : check);
        ...
        if(!snoozed) {
            holder.toggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                    ...
                    new BooleanPreferenceDataCalander(PreferenceData.CALANDAR, R.string.open_calandar, R.string.desc_calandar,!b);
