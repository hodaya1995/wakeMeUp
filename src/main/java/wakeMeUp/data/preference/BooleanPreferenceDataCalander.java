...
public class BooleanPreferenceDataCalander extends BasePreferenceData<BooleanPreferenceDataCalander.ViewHolder> {
    ...
    public BooleanPreferenceDataCalander(PreferenceData preference, @StringRes int title, @StringRes int description,boolean check) {
    ...
    public BasePreferenceData.ViewHolder getViewHolder(LayoutInflater inflater, ViewGroup parent) {
        return new BooleanPreferenceDataCalander.ViewHolder(inflater.inflate(R.layout.item_preference_boolean, parent, false));
    }

    @Override
    public void bindViewHolder(final BooleanPreferenceDataCalander.ViewHolder holder) {
        ...
        if(!snoozed) {
            holder.toggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                    ...
                    new BooleanPreferenceDataGmail(PreferenceData.GMAIL, R.string.open_gmail, R.string.desc_gmail,true);
                }
            });
        }else{
            holder.toggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
