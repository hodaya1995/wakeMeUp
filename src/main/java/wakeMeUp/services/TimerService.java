...
public class TimerService extends Service {
    ...
    public static String TAG="TimerService";
    ...
    private Notification getNotification() {
        ...
        for (TimerData timer : timers) {
            ...
            String time = FormatUtils.formatMillis(timer.getRemainingMillis(),true);
        ...
        String time = FormatUtils.formatMillis(timers.get(0).getRemainingMillis(),true);
        time = time.substring(0, time.length() - 3);
