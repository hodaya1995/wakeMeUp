package me.jfenn.wakeMeUp.services;
...
public class StopwatchService extends Service {
        ...
        runnable = new Runnable() {
            ...
            public void run() {
                if (isRunning) {
                    ...
                    String text = FormatUtils.formatMillis(currentTime,true);
                    if (listener != null)
                    ...
                    listener.onTick(time, FormatUtils.formatMillis(time,true));
                }
            }
        };
    ...
    public void toggle() {
        ...
        notificationText = FormatUtils.formatMillis(System.currentTimeMillis() - startTime,true);
