...
import me.jfenn.wakeMeUp.services.StopwatchService;
...
public class StopwatchFragment extends BaseFragment implements StopwatchService.Listener, ServiceConnection {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (service != null) {
                    String time = FormatUtils.formatMillis(service.getElapsedTime(),true);
                    ...
                    for (int i = 0; i < laps.size(); i++) {
                        ...
                        content.append(getContext().getString(R.string.title_lap_number, laps.size() - i))
                                .append("    \t")
                                .append(getContext().getString(R.string.title_lap_time, FormatUtils.formatMillis(lapTime,true)))
                                .append("    \t")
                                .append(getContext().getString(R.string.title_total_time, FormatUtils.formatMillis(total,true)));
    ...
    public void onLap(int lapNum, long lapTime, long lastLapTime, long lapDiff) {
        ...
        if(number.getParent() != null) {
            ((ViewGroup)number.getParent()).removeView(number);
        }
        ...
        lap.setText(getString(R.string.title_lap_time, FormatUtils.formatMillis(lapDiff,true)));
        lap.setTextColor(textColorPrimary);
        if(lap.getParent() != null) {
            ((ViewGroup)lap.getParent()).removeView(lap); // <- fix
        }
        layout.addView(lap);
        ...
        total.setText(getString(R.string.title_total_time, FormatUtils.formatMillis(lapTime,true)));
        total.setTextColor(textColorPrimary);
        if(total.getParent() != null) {
            ((ViewGroup)total.getParent()).removeView(total); // <- fix
        }
